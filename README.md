...
**[Download MixedStorage v0.5.2](https://github.com/kramsey458/MixedStorage/releases/download/v0.5.2/MixedStorage-v0.5.2.zip)** · [Release notes](https://github.com/kramsey458/MixedStorage/releases/tag/v0.5.2) · [Report a problem](https://github.com/kramsey458/MixedStorage/issues)

> **v0.5.2 is a prerelease**, built for Timberborn **1.1.2.4**. One download covers single-player and BeaverBuddies multiplayer. Recent layout and visual changes still need more in-game testing.
...
1. Download **MixedStorage-v0.5.2.zip** above. On the release page, choose that file under **Assets**, not **Source code**.
...
Players have reported successful use of earlier builds. Automated allocation, geometry, native API, and optional multiplayer loading checks pass, but these do not replace live gameplay testing. **The v0.5.2 layout has not yet been visually verified in game.**
