...
**[Download v0.5.2 visual prototype from Releases](https://github.com/kramsey458/MixedStorage/releases/tag/v0.5.2).**

**MixedStorage-v0.5.2.zip** is the only package for single-player and multiplayer. BeaverBuddies support is bundled and activates automatically when BeaverBuddies is enabled.
